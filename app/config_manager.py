    ...
    def _configure_monitoring_endpoints(self):
        ...
        if self.environment == 'production':
            ...
            self.monitoring.prometheus_endpoint = os.getenv(
                'PROMETHEUS_ENDPOINT', 
                'https://prometheus.smartcloudops.ai'
            )
            self.monitoring.grafana_endpoint = os.getenv(
                'GRAFANA_ENDPOINT',
                'https://grafana.smartcloudops.ai'
            )
        elif self.environment == 'staging':
            # Staging endpoints
            self.monitoring.prometheus_endpoint = os.getenv(
                'PROMETHEUS_ENDPOINT',
                'https://prometheus-staging.smartcloudops.ai'
            )
            self.monitoring.grafana_endpoint = os.getenv(
                'GRAFANA_ENDPOINT',
                'https://grafana-staging.smartcloudops.ai'
            )
        else:
...
def main():
    ...
    parser.add_argument('--save-templates', action='store_true',
                       help='Save configuration templates')
