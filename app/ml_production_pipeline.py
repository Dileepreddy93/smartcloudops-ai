...
class ABTestManager:
    ...
    def record_prediction(self, test_id: str, model_version: str, 
                         prediction: int, latency_ms: float):
...
class ProductionMLPipeline:
    ...
    def predict(self, metrics: Dict[str, float], 
                user_id: Optional[str] = None,
                ab_test_id: Optional[str] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            if ab_test_id:
                self.ab_test_manager.record_prediction(
                    ab_test_id, metadata_to_use.version, 
                    1 if prediction == -1 else 0, latency_ms
                )
