...
class AutoRemediationEngine:
    ...
    def _initialize_default_rules(self):
        ...
        critical_failure_rule = RemediationRule(
            ...
            actions=[RemediationAction.EMERGENCY_SHUTDOWN, RemediationAction.SEND_ALERT],
        ...
        low_utilization_rule = RemediationRule(
            ...
            conditions={
                "cpu_percent": {"threshold": 20, "duration_minutes": 10, "operator": "lt"},
                "memory_percent": {"threshold": 30, "duration_minutes": 10, "operator": "lt"}
            },
