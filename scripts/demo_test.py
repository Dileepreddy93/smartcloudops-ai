...
def demo_auto_remediation():
    ...
    try:
        ...
        test_scenarios = [
            {
                "name": "High CPU Usage",
                "metrics": {"cpu_percent": 95.0, "memory_percent": 70.0, "disk_percent": 60.0}
            },
            {
                "name": "Memory Pressure",
                "metrics": {"cpu_percent": 60.0, "memory_percent": 90.0, "disk_percent": 50.0}
            },
            {
                "name": "Disk Space Critical",
                "metrics": {"cpu_percent": 40.0, "memory_percent": 50.0, "disk_percent": 95.0}
            }
        ]
...
def demo_infrastructure():
    ...
    try:
        ...
        # Show key components
        key_components = [
            "main.py", "services/", "api/v1/", "core/ml_engine/",
            "utils/", "config/"
        ]
