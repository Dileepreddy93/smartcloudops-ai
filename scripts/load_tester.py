...
class LoadTester:
    ...
    def __init__(self, base_url: str = "http://localhost:5000"):
        ...
        self.api_key = os.getenv('TEST_API_KEY', 'sk-readonly-demo-key-12345678901234567890')
        self.results = []
        self.setup_logging()
    ...
    def analyze_results(self) -> Dict[str, Any]:
        ...
        stats = {
            ...
            'requests_per_second': len(self.results) / (max([r['timestamp'] for r in self.results]) if self.results else 1),
