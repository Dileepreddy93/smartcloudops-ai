...
"""
    ...
    def analyze_and_alert(self, system_health: Dict, app_health: Dict, 
                         ml_health: Dict, db_health: Dict):
    ...
    def run_monitoring_cycle(self):
        ...
        # Log current status
        self.logger.info(f"System: CPU {system_health.get('cpu_percent', 0):.1f}%, "
                        f"Memory {system_health.get('memory_percent', 0):.1f}%, "
                        f"Disk {system_health.get('disk_percent', 0):.1f}%")
        
        self.logger.info(f"Application: Status {app_health.get('status_code', 0)}, "
