...
class TestBase:
    ...
    def make_request(self, method: str, endpoint: str, 
                    api_key: str = None, data: Dict = None) -> requests.Response:
...
class TestAPIEndpoints(TestBase):
    ...
    def test_health_endpoint(self):
        ...
        response = self.make_request('GET', '/health', 
                                   api_key=TEST_CONFIG['api_keys']['admin'])
    ...
    def test_status_endpoint(self):
        ...
        response = self.make_request('GET', '/status', 
                                   api_key=TEST_CONFIG['api_keys']['readonly'])
    ...
    def test_ml_prediction_endpoint(self):
        ...
        response = self.make_request('POST', '/ml/predict', 
...
class TestPerformanceLoad(TestBase):
    ...
    def test_ml_pipeline_performance(self):
        ...
        def make_ml_request():
            data = {'metrics': self.test_metrics}
            return self.make_request('POST', '/ml/predict', 
                                   api_key=TEST_CONFIG['api_keys']['ml'],
                                   data=data)
...
def run_all_tests():
    ...
    passed_tests = sum(1 for test in test_results['unit_tests'] 
                      if test['status'] == 'PASS')
