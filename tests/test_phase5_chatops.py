...
from app.services.aws_integration_service import AWSIntegrationService, aws_integration_service
...
class TestAWSIntegrationService:
    ...
    def test_execute_scale(self, aws_service):
        ...
        with patch.object(aws_service.autoscaling_client, 'describe_auto_scaling_groups') as mock_describe:
            ...
            with patch.object(aws_service.autoscaling_client, 'set_desired_capacity') as mock_set:
